...
const styles = StyleSheet.create({
  ...
  emptyText: { fontSize: 15, fontWeight: "700", letterSpacing: 1, color: "#9CA3AF" },
  ...
  rowMid: { flex: 1 },
  actName: { fontSize: 15, fontWeight: "700", letterSpacing: 1, marginBottom: 2 },
  actMeta: { fontSize: 13, fontWeight: "700", letterSpacing: 0.8, color: "#6B7280" },
  kcalBadge: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8 },
  kcalText: { fontSize: 13, fontWeight: "700", letterSpacing: 0.8 },
});
