...
const styles = StyleSheet.create({
  ...
  sub: { fontSize: 13, fontWeight: "700", marginTop: 1, color: "#6B7280" },
  center: { alignItems: "center", justifyContent: "center", paddingVertical: 28, gap: 4 },
  emptyTitle: { fontSize: 18, fontWeight: "700", color: "#1A1A1A" },
  emptyBody: { fontSize: 14, fontWeight: "700", color: "#6B7280" },

  groups: { gap: 0 },
  group: { borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: "rgba(0,0,0,0.07)", paddingTop: 8, paddingBottom: 4, gap: 4 },
  tagLabel: { fontSize: 14, fontWeight: "700", marginBottom: 2, color: "#2BB6A6" },
  itemRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  itemName: { fontSize: 14, fontWeight: "700", flex: 1, marginRight: 8, color: "#1A1A1A" },
  itemKcal: { fontSize: 13, fontWeight: "700", color: "#6B7280" },
  more: { fontSize: 13, fontWeight: "700", marginTop: 2, color: "#9CA3AF" },
});
