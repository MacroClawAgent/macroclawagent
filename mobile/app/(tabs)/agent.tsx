    ...
    return (
      <SafeAreaView style={s.safe} edges={['top']}>
        <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
          <View style={s.header}>
            <View>
              <Text style={s.title}>{mealCtx.greeting} {mealCtx.emoji}</Text>
              <Text style={s.subtitle}>Here's your {singleMeal.type} — Generated by Jonno ✦</Text>
            </View>
    ...
    <SafeAreaView style={s.safe} edges={['top']}>
      ...
      >
        ...
        {todayConsumed && (() => {
          ...
          return (
            <View style={s.macroGapCard}>
              <View style={s.macroGapHeader}>
                <Text style={s.macroGapTitle}>Today so far</Text>
                <Text style={s.macroGapPct}>{pct}% of goal</Text>
              </View>
              <View style={s.macroGapTrack}>
                <View style={[s.macroGapFill, { width: `${pct}%` as any }]} />
              </View>
              <View style={s.macroGapStats}>
                <Text style={s.macroGapStat}><Text style={s.macroGapVal}>{remCal}</Text> kcal remaining</Text>
                <Text style={s.macroGapDot}>·</Text>
                <Text style={s.macroGapStat}><Text style={[s.macroGapVal, { color: '#16A34A' }]}>{remPro}g</Text> protein left</Text>
              </View>
            </View>
          );
        })()}
        ...
        <View style={s.heroCard}>
          ...
          <View style={s.heroGreeting}>
            ...
            <Text style={s.heroGreetingText}>{mealCtx.greeting}</Text>
          </View>
        ...
        {/* ── Pantry strip ──────────────────────────────────────────────── */}
        <View style={s.pantryCard}>
          <View style={s.pantryHeader}>
            <Text style={s.pantryTitle}>🥬 In your kitchen</Text>
          ...
          {pantryItems.length === 0 && !addingPantry ? (
            <Text style={s.pantryEmpty}>No items yet — add ingredients or send a meal plan to cart to auto-populate</Text>
          ) : (
