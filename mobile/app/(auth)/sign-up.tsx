  ...
  return (
    ...
    >
      <View style={styles.inner}>
        ...
        <Text style={styles.subtitle}>Start fuelling your training with AI-powered nutrition.</Text>
        ...
        <View style={styles.form}>
          ...
          <Text style={styles.legal}>
            By signing up you agree to our Privacy Policy. No credit card required.
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  legal: { fontSize: 11, color: "rgba(245,245,247,0.35)", textAlign: "center", lineHeight: 16 },
