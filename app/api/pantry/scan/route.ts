...
import { scanPantryImage } from "@/src/llm/gateway";

/**
 * POST /api/pantry/scan
 *
 * Sends a fridge/pantry photo to Claude Vision and returns a list of
 * identified ingredient names for the user to confirm.
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await scanPantryImage(imageBase64, mimeType);
