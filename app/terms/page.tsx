            ...
            <div className="light-card p-8 md:p-12">
              ...
              <section className="mb-10">
                ...
                <ul className="space-y-2 text-gray-600 mb-4">
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span>Provide accurate, current, and complete information during registration</li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span>Maintain and promptly update your account information</li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span>Keep your password confidential and not share it with others</li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span>Notify us immediately of any unauthorised use of your account</li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span>Accept responsibility for all activities that occur under your account</li>
                </ul>
              </section>

              <section className="mb-10">
                <h2 className="text-xl font-bold text-gray-900 mb-4">3. Subscriptions and Billing</h2>
                <p className="text-gray-600 leading-relaxed mb-3">
                  Certain features of the Service require a paid subscription (Pro or Elite plans). By
                  subscribing, you agree to the following:
                </p>
                <ul className="space-y-2 text-gray-600 mb-4">
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span>Subscriptions are billed monthly or annually in advance</li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span>Subscriptions automatically renew unless cancelled before the renewal date</li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span>You may cancel at any time; cancellations take effect at the end of the current billing period</li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span>We do not offer refunds for partial billing periods, except where required by applicable law</li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span>We reserve the right to change pricing with 30 days notice to existing subscribers</li>
                </ul>
                <p className="text-gray-600 leading-relaxed">
              ...
              <section className="mb-10">
                <h2 className="text-xl font-bold text-gray-900 mb-4">5. Health Disclaimer</h2>
                <div className="p-4 bg-amber-500/10 border border-amber-500/20 rounded-xl mb-4">
                  ...
                  <p className="text-sm text-amber-300/80">
                    Jonno is a nutrition tracking and planning tool. It is not a medical device,
              ...
              <section className="mb-10">
                ...
                <p className="text-gray-600 leading-relaxed mb-3">
                  The Service, including its software, design, content, trademarks, and the &ldquo;Jonno Agent&rdquo;
                  branding, is owned by Jonno and protected by intellectual property laws.
                </p>
                <p className="text-gray-600 leading-relaxed">
              ...
              <section>
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  <a href="mailto:legal@macroclawagent.com" className="text-blue-600 hover:text-blue-500 transition-colors">
