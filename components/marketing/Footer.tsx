      ...
      <div className="max-w-6xl mx-auto px-6 pt-16 pb-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex items-center gap-3 mt-6">
              <a
                ...
                className="w-9 h-9 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-gray-500 hover:text-gray-200 transition-all duration-200"
              >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-blue-900/30 border border-blue-800/30">
            ...
            <span className="text-xs font-bold text-blue-200">Claude AI</span>
