...
function DashboardCard() {
  return (
    <div className="flex flex-col h-full gap-5 p-6 glass-card glow-border rounded-2xl">
...
function AgentCard() {
  return (
    <div className="flex flex-col h-full gap-4 p-5 glass-card rounded-2xl">
...
function StravaCard() {
  return (
    <div className="flex flex-col gap-4 p-5 glass-card rounded-2xl h-full">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
...
function MacroCard() {
  return (
    <div className="flex flex-col gap-3 p-5 glass-card rounded-2xl h-full justify-center bg-gradient-to-br from-indigo-900/20 to-transparent">
...
function StreakCard() {
  ...
  return (
    <div className="flex flex-col gap-3 p-5 glass-card rounded-2xl h-full">
      <div className="flex items-center gap-2">
